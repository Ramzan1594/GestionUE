        ...
        public static class ExceptionHandlers
        {
            ...
            static ExceptionHandlers()
            {
                ...
                ExceptionHandlers.DicoException.Add("PPHY_SES_ATT",
                    ...
                    "ou possède une attestation de réussite de moins de 5 ans. \n"
                    + "Êtes-vous sur de vouloir continuer ?");

                // DB ATT----- Attestation
                ExceptionHandlers.DicoException.Add("FK_ATT_PPHY", "Suppression de l'attestation refusée : elle est liée à un ou plusieurs étudiants qui la possède");
                ExceptionHandlers.DicoException.Add("FK_ATT_UE", "Suppression de l'attestation refusée : une ou plusieurs UE lui sont liées");
                // DB PAR----- Participe
                ExceptionHandlers.DicoException.Add("FK_PAR_SES", "Inscription refusée, avez vous choisit une session ?");
                ExceptionHandlers.DicoException.Add("FK_PAR_PPHY", "Inscritption refusée, avez-vous bien sélectionné un étudiant ?");
                // DB PPHY----- Personne
                ExceptionHandlers.DicoException.Add("FK_PPHY_LOC", "Inscription de l'étudiant refusée, veuillez encoder une adresse complète !");
                ExceptionHandlers.DicoException.Add("FK_PPHY_SEC", "Inscription de l'étudiant refusée, le choix d'une section est impératif !");
                ExceptionHandlers.DicoException.Add("FK_PPHY_NAT", "Inscription de l'étudiant refusée, veuillez encoder une nationalité valide !");
                // DB REQ----- Requis
                ...
                // DB SEA----- Séance
                ExceptionHandlers.DicoException.Add("FK_SEA_SES", "Une séances doit faire partie d'une session, veuillez en sélectionneer une !");
                // DB SES----- Session
                ExceptionHandlers.DicoException.Add("FK_SES_UE", "Une session fait partie d'une UE, veuillez sélectionner une UE avant d'encoder une session !");
                // DB UE----- Unité d'enseignemant
                ExceptionHandlers.DicoException.Add("FK_UE_SEC", "Une UE doit appartenir à une section, veuillez sélectionner une section avant de poursuivre l'encodage des UE !");
            }
            //-------------------------------------------------------------
